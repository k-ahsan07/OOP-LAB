...
public:
    ...
    float getvar11() const { return var11; }
    float getvar12() const { return var12; }
    float getvar21() const { return var21; }
    float getvar22() const { return var22; }
    void setvar11(float var11){ this->var11=var11; }
    void setvar12(float var12){ this->var12=var12; }
    void setvar21(float var21){ this->var21=var21; }
    void setvar22(float var22){ this->var22=var22; }
...
public:
    ...
    float getvar13() const { return var13; }
    float getvar23() const { return var23; }
    float getvar31() const { return var31; }
    float getvar32() const { return var32; }
    float getvar33() const { return var33; }
    void setvar33(float var33){ this->var33=var33; }
    void setvar13(float var13){ this->var13=var13; }
    void setvar23(float var23){ this->var23=var23; }
    void setvar31(float var31){ this->var31=var31; }
    void setvar32(float var32){ this->var32=var32; }
...
int main(){
	cout<<"Enter which type of Matrix do you want \n PRESS 0 FOR 2*2 \n PRESS 1 FOR 3*3"<<endl;
	bool a;
	cin>>a;
	if(a==0){
		float a,b,c,d;
